...
/*   Updated: 2026/07/29 15:12:48 by zatais           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
private:
  ...
  int toInt(std::string &s, const std::string &context, int min_value,
            int max_value);
  ...
  void assignServerDirective(ServerConfig &server,
                             std::vector<std::string> &tokens, size_t &idx);
  void assignLocationDirective(Location &loc, std::vector<std::string> &tokens,
                               size_t &idx);
  ...
  std::vector<std::string> collectValues(std::vector<std::string> &tokens,
                                         size_t &idx, const std::string &key);
